...
"}")
        ...
        self.btn_ProductUc3 = QPushButton(self.updater_page)
        self.btn_ProductUc3.setObjectName(u"btn_ProductUc3")
        self.btn_ProductUc3.setMinimumSize(QSize(0, 30))

        self.verticalLayout_3.addWidget(self.btn_ProductUc3)
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_ProductUc3.setText(QCoreApplication.translate("MainWindow", u"Target uC3", None))
