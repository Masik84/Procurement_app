...
class SupplierPriceExporter:
    ...
    def _apply_calculated_export_formats_by_header(self, ws, headers: list[str]) -> None:
        ...
        self._set_width_by_header(ws, header_map, "Target price (for suppl)", 8.14)
        self._set_width_by_header(ws, header_map, "Target uC3", 7.14)
        self._set_width_by_header(ws, header_map, "Walk-Away uC3", 7.14)
        self._set_width_by_header(ws, header_map, "Markup % (from suppl price)", 7.14)
        self._set_width_by_header(ws, header_map, "abs Change", 7.0)
        self._set_width_by_header(ws, header_map, "Best uC3", 5.71)
        self._set_width_by_header(ws, header_map, "Best 2 uC3", 5.71)
